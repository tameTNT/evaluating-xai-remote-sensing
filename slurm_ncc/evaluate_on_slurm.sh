...
printf '%s\n' "#!/bin/bash" \
       ...
       "$(printf '%s ' "python batch_evaluate.py --dataset_name $dataset_name --model_name $model_name --explainer_name $explainer_name $args ${@:3}")" > ~/l3_project/slurm_ncc/evaluate_temp.batch
